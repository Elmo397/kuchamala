package com.kuchamala.old_code.wp.page.generator

import com.kuchamala.old_code.database.model.ClassesModel
import com.kuchamala.old_code.database.model.TeacherClassesModel
import com.kuchamala.wp.page.WordPressDatabaseWriter

fun main() {
    println(PageGenerator().demoPage())
}
